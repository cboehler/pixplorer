 ...
 */
package appjunkies.pixplorer.other;
 ...
 */
public class FontAwesomeFont implements ITypeface {
    private static final String TTF_FILE = "fontawesome.ttf";
