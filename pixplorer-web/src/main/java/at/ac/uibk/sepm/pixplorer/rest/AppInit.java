	...
	private void createDummyContent() {
		 ...
		 */
			...
			//SIGHTS***********************************************
				...
				gps.setLongitude(47.268653);
				gps.setLatitude(11.393275);
				...
				//Schloss_Ambras
				gps = new GPSData();
				gps.setLongitude(47.256614);
				gps.setLatitude(11.433551);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				//Triumphpforte
				gps = new GPSData();
				gps.setLongitude(47.262600);
				gps.setLatitude(11.394777);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				gps = new GPSData();
				gps.setLongitude(47.293773);
				gps.setLatitude(11.600792);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				//Kaiserliche Hofburg
				gps = new GPSData();
				gps.setLongitude(47.268887);
				gps.setLatitude(11.394571);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				gps = new GPSData();
				gps.setLongitude(47.268523);
				gps.setLatitude(11.395421);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				//Annasäule
				gps = new GPSData();
				gps.setLongitude(47.265640);
				gps.setLatitude(11.394252);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				//Dom Innsbruck
				gps = new GPSData();
				gps.setLongitude(47.269509);
				gps.setLatitude(11.393794);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				gps = new GPSData();
				gps.setLongitude(47.263613);
				gps.setLatitude(11.394913);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				//Stadtturm Innsbruck
				gps = new GPSData();
				gps.setLongitude(47.268230);
				gps.setLatitude(11.393459);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
			...
			//MUSEUM***********************************************	
				...
				gps = new GPSData();
				gps.setLongitude(47.256145);
				gps.setLatitude(11.398232);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				gps = new GPSData();
				gps.setLongitude(47.250521);
				gps.setLatitude(11.401608);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				gps = new GPSData();
				gps.setLongitude(47.279336);
				gps.setLatitude(11.403465);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
			...
			//OTHER***********************************************	
				...
				//Hauptuni Innsbruck
				gps = new GPSData();
				gps.setLongitude(47.263415);
				gps.setLatitude(11.384507);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				gps = new GPSData();
				gps.setLongitude(47.264089);
				gps.setLatitude(11.344598);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				//AlpenZoo Innsbruck
				gps = new GPSData();
				gps.setLongitude(47.281206);
				gps.setLatitude(11.398171);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
			...
			//TRAVEL***********************************************	
				...
				//Bahnhof Innsbruck
				gps = new GPSData();
				gps.setLongitude(47.263578);
				gps.setLatitude(11.400340);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				gps = new GPSData();
				gps.setLongitude(47.286516);
				gps.setLatitude(11.398595);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
			...
			//MOUNTAIN***********************************************	
				...
				//Nordkette Innsbruck
				gps = new GPSData();
				gps.setLongitude(47.306605);
				gps.setLatitude(11.380478);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
			...
			//RESTAURANT***********************************************	
				...
				gps = new GPSData();
				gps.setLongitude(47.268421);
				gps.setLatitude(11.392375);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				//Ottoburg Innsbruck
				gps = new GPSData();
				gps.setLongitude(47.268521);
				gps.setLatitude(11.391980);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
			...
			//BAR***********************************************	
				...
				gps = new GPSData();
				gps.setLongitude(47.266150);
				gps.setLatitude(11.401455);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				//Stadtcafe Innsbruck
				gps = new GPSData();
				gps.setLongitude(47.268872);
				gps.setLatitude(11.395799);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				//Pavillion Innsbruck
				gps = new GPSData();
				gps.setLongitude(47.269782);
				gps.setLatitude(11.395639);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
			...
			//SPORT***********************************************	
				...
				//Tivoli Innsbruck
				gps = new GPSData();
				gps.setLongitude(47.256796);
				gps.setLatitude(11.412221);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				gps = new GPSData();
				gps.setLongitude(47.258439);
				gps.setLatitude(11.410454);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				//Bergisel Schanze
				gps = new GPSData();
				gps.setLongitude(47.249074);
				gps.setLatitude(11.399444);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				gps = new GPSData();
				gps.setLongitude(47.277158);
				gps.setLatitude(11.414350);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
			...
			//PLACES***********************************************	
				...
				gps = new GPSData();
				gps.setLongitude(47.264942);
				gps.setLatitude(11.397539);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				gps = new GPSData();
				gps.setLongitude(47.264034);
				gps.setLatitude(11.396167);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				//Stift Wilten
				gps = new GPSData();
				gps.setLongitude(47.253654);
				gps.setLatitude(11.400488);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				gps = new GPSData();
				gps.setLongitude(47.268228);
				gps.setLatitude(11.389511);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
			...
			//TEST***********************************************	
				...
				//Home Leo Innsbruck
				gps = new GPSData();
				gps.setLongitude(47.268629);
				gps.setLatitude(11.355626);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				PersistenceManager.save(place);			
							...
							//Home Leo Südtirol
				gps = new GPSData();
				gps.setLongitude(46.716950);
				gps.setLatitude(11.877246);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				gps = new GPSData();
				gps.setLongitude(47.266392);
				gps.setLatitude(11.362054);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
			...
			//SÜDTIROL***********************************************	
				...
				//Bruneck Rathaus
				gps = new GPSData();
				gps.setLongitude(46.796305);
				gps.setLatitude(11.935422);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				//Schloss Bruneck
				gps = new GPSData();
				gps.setLongitude(46.794143);
				gps.setLatitude(11.939882);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				//Ursulinen Bruneck
				gps = new GPSData();
				gps.setLongitude(46.795092);
				gps.setLatitude(11.936072);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				//Hotel Post Bruneck
				gps = new GPSData();
				gps.setLongitude(46.796503);
				gps.setLatitude(11.936169);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
				...
				//Kronplatz Concordia
				gps = new GPSData();
				gps.setLongitude(46.738488);
				gps.setLatitude(11.958540);
				PersistenceManager.save(gps);
				place = new Place();
				place.setCategory(cat);
				place.setGpsData(gps);
