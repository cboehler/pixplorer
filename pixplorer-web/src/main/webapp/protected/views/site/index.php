...
<ul>
	...
	<li> <a href="http://localhost/pixplorer/index.php?r=Users">User</a> </li>
	...
	<li> <a href="http://localhost/pixplorer/index.php?r=Gpsdata">GpsData</a> </li>
	<li> <a href="http://localhost/pixplorer/index.php?r=Trophies">Trophies</a> </li>
	<li> <a href="http://localhost/pixplorer/index.php?r=Favourites">Favourites</a> </li>
	<li> <a href="http://localhost/pixplorer/index.php?r=History">History</a> </li>
	<li> <a href="http://localhost/pixplorer/index.php?r=usertrophymapping">UserTrophies</a> </li>
